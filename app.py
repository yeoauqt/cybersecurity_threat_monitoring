...
# NOTE: updated to snake_case to match the actual warehouse schema.
REQUIRED_COLUMNS = {
    "fact": [
...
try:
    ...
    # Extra diagnostics: show the raw columns of every parquet file
    # so schema drift on any table (not just 'fact') is easy to spot
    # without iterating through KeyErrors one table at a time.
